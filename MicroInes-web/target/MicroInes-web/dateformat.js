 var oldDatee = document.getElementById('dateEdit').innerHTML;
            const a=oldDatee;
            //var m=a[5]+a[6]+"/"+a[8]+a[9]+"/"+a[0]+a[1]+a[2]+a[3]+" "+a[11]+a[12]+a[13]+a[14]+a[15]+a[16]+a[17]+a[18];
            //const m=a[8]+a[9]+"/"+a[5]+a[6]+"/"+a[0]+a[1]+a[2]+a[3]+" "+a[11]+a[12]+a[13]+a[14]+a[15]+a[16]+a[17]+a[18]
            var m="10/06/2020 14:00:00"
            console.log(m);
